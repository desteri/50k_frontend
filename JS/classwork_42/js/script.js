...
// let resInput = +prompt("Введите номер страницы:", '');
...
// console.log(`https://miukid.com/cat/${resInput}`);
...
let delElem = (ev) => {
    alert(`Вы кликнули на кнопку: ${ev.target.innerText}`);
};

click.addEventListener('click', delElem);
click2.addEventListener('click', delElem);
